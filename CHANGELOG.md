...
- Make the publisher-live watchdog regression wait for the observable recovery result instead of cancelling the supervision loop during a slow test runner scheduling window.
