...
public sealed class SimulationDeckLinkEnumerator : IDeckLinkEnumerator
{
    public Task<IReadOnlyList<DeckLinkPort>> EnumerateAsync(CancellationToken cancellationToken)
    {
        ...
        [
            new("SIM-CARD-0-PORT-0", "Simulated DeckLink (1)", "DeckLink Quad 2 (simulation)", 0, 0, "SIM:00:00.0", modes, FriendlyName: "Studio Return 1", IdentityConfidence: "Simulation", IsOutputPort: true),
            new("SIM-CARD-0-PORT-1", "Simulated DeckLink (2)", "DeckLink Quad 2 (simulation)", 0, 1, "SIM:00:00.0", modes, FriendlyName: "Studio Return 2", IdentityConfidence: "Simulation", IsOutputPort: true)
        ];
